...
public class ListToCsv {
        ...
        private static final Logger logger = LoggerFactory.getLogger(ListToCsv.class);

        public static <T> void exportCSV(List<T> dataList, String fileName) {
            exportCSVToFile(dataList, fileName);
        }

        public static <T> void exportCSV(List<T> dataList, HttpServletResponse response, String fileName) {
            exportCSVToHttpResponse(dataList, response, fileName);
        }

        private static <T> void exportCSVToFile(List<T> dataList, String fileName) {
        ...
        private static <T> void exportCSVToHttpResponse(List<T> dataList, HttpServletResponse response, String fileName) {
            if (dataList == null || dataList.isEmpty()) {
                logger.error("No data to export to CSV.");
                return;
            }
        ...
        private static <T> String generateFileName(List<T> dataList) {
            if (dataList == null || dataList.isEmpty()) {
                return "default";
            }
